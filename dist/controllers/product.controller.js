...
productRouter.get("/:id", auth_services_1.protect, (0, auth_services_1.restrictTo)("manager", "admin"), product_validator_1.deleteProductValidator, product_services_1.getProduct);
